export const NFTDEX_NAME = "nftdexnftdex";
export const SIMPLEASSET_NAME = "simpleassets";
...
export const OFFERCREATE_ACTION = "offercreate";
export const SASSETRM_ACTION = "sassetrm";
export const DAPPSERVICES_PERMISSION = "dappservices";
export const OFFERSDELETE_ACTION = "offerdelete";
export const OFFERSRENEW_ACTION = "offerrenew";
export const OPTION_ACCEPT = "optionaccept";
